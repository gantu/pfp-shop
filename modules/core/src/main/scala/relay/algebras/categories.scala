...
import relay.domain.category._
import relay.effects._
import relay.ext.skunkx._
...
private object CategoryQueries {
  ...
  val selectAll: Query[Void, Category] = sql"""
        SELECT * FROM categories
        """.query(codec)

  val insertCategory: Command[Category] = sql"""
